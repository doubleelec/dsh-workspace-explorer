window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var panel_module_css_default = {
			...
			"dshwe-resize-w": "pEQVpG_dshwe-resize-w",
			...
			"dshwe-resize-w-bar": "pEQVpG_dshwe-resize-w-bar",
		...
		*/
		...
		function DrawerRoot(props) {
			...
			const resizeWRef = (0, react.useRef)(null);
			const applyResizeWDelta = (clientX) => {
			...
			const onResizeWMove = (ev) => applyResizeWDelta(ev.clientX);
			const onResizeWTouchMove = (ev) => {
				if (ev.touches.length > 0) applyResizeWDelta(ev.touches[0].clientX);
			};
			const onResizeWDown = (e) => {
				e.preventDefault();
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [dragKind !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: C("dshwe-resize-w"),
							onMouseDown: onResizeWDown,
							onTouchStart: onResizeWTouchStart,
							onDoubleClick: onResizeWReset,
							title: tr("resizeW.tip"),
							role: "separator",
							"aria-orientation": "vertical",
							"aria-label": tr("resizeW.tip"),
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: C("dshwe-resize-w-bar") })
						}),
