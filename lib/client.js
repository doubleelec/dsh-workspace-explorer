		...
		*/
		...
		const DICTS = {
			zh: {
				...
				hint: "点击预览 / ↙ 插入到对话;目录行也有 ↙(插入 @目录/);拖拽也可插入;Shift 或 ⌘ 点击多选批量插入",
			...
			en: {
				...
				hint: "Click to preview / ↙ to insert; folders have ↙ too (@dir/); drag also inserts; Shift or ⌘ click to select multiple",
