window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function getSavedHtmlView() {
			return savedHtmlView;
		}
		function saveHtmlView(v) {
			savedHtmlView = v;
		}
		...
		*/
		const HTML_EXTS = /* @__PURE__ */ new Set([
			"html",
			"htm",
			"xhtml"
		]);
		...
		*/
		...
		const DICTS = {
			zh: {
				...
				"html.source": "源码",
				"html.rendered": "渲染",
				"html.source.tip": "查看 HTML 源码",
				"html.rendered.tip": "查看渲染效果",
				"mermaid.render": "渲染图表",
			...
			en: {
				...
				"html.source.tip": "View HTML source",
				"html.rendered.tip": "View rendered output",
		...
		function Panel(props) {
			...
			const [htmlView, setHtmlView] = (0, react.useState)(() => getSavedHtmlView());
			...
			if (preview) {
				...
				else if (htmlRendered && htmlView === "rendered") contentArea = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("iframe", {
					className: C("dshwe-html"),
					sandbox: "",
					srcDoc: d?.content ?? "",
							...
							children: [
								...
								isEdit ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: C("dshwe-pager-btn"),
										disabled: fontStep <= -1 || preview.loading || htmlRendered && htmlView === "rendered",
										onClick: fontDec,
										title: tr("font.dec"),
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: C("dshwe-pager-btn"),
										disabled: fontStep >= 3 || preview.loading || htmlRendered && htmlView === "rendered",
										onClick: fontInc,
										title: tr("font.inc"),
									...
									htmlRendered ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: C("dshwe-prevbtn") + (htmlView === "source" ? ` ${C("dshwe-prevbtn-on")}` : ""),
										onClick: () => {
											const v = htmlView === "rendered" ? "source" : "rendered";
											setHtmlView(v);
											saveHtmlView(v);
										},
										title: htmlView === "rendered" ? tr("html.source.tip") : tr("html.rendered.tip"),
										children: htmlView === "rendered" ? tr("html.source") : tr("html.rendered")
									}) : null,
		...
		function DrawerRoot(props) {
			...
			const fullscreenRef = (0, react.useRef)(fullscreen);
			fullscreenRef.current = fullscreen;
			const fullRectRef = (0, react.useRef)(fullRect);
