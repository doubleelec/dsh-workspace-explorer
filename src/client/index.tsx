...
const DICTS: Record<string, Record<string, string>> = {
  zh: {
    ...
    hint: '点击文件预览 | 点击 ↙ 或拖拽文件插入到对话 | Shift 或 Ctrl 点击多选批量插入', 'empty.title': '还没有可浏览的工作区。选择一个项目文件夹,即可在这里查看目录文件。',
  ...
  en: {
    ...
    hint: 'Click a file to preview | ↙ or drag to insert into chat | Shift or Ctrl click to select multiple', 'empty.title': 'No browsable workspace yet. Pick a project folder to view its files.',
